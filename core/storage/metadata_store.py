...
SECTION_ALIASES: dict[str, list[str]] = {
    ...
    "Human Capital": ["human capital", "human capital resources", "employees", "people", "workforce", "talent"],
    "Competition": ["competition", "competitive landscape", "competitive environment"],
    "Supply of Components": ["supply of components", "components", "suppliers", "supply chain", "manufacturing", "sourcing"],
    "Products": ["products", "product", "wearables", "home", "accessories", "iphone", "ipad", "mac", "services"],
    ...
    "Management's Discussion": ["management's discussion", "md&a", "results of operations", "financial condition"],
    "Liquidity and Capital Resources": ["liquidity", "capital resources", "cash flow", "cash"],
    "Critical Accounting Estimates": ["critical accounting", "accounting estimates", "accounting policies"],
    # Item 7A: Quantitative and Qualitative Disclosures About Market Risk
    "Market Risk Disclosures": ["quantitative", "qualitative", "market risk disclosures"],
    # Item 8: Financial Statements
    "Financial Statements": ["financial statements", "income statement", "balance sheet", "cash flow statement"],
    ...
    "Operating Expenses": ["operating expenses", "r&d", "research and development", "sg&a", "selling general and administrative"],
    "Income Taxes": ["income taxes", "tax", "taxation", "tax provision"],
    # Item 9: Changes in and Disagreements with Accountants
    "Accountants": ["accountants", "accounting changes", "audit"],
    # Item 9A: Controls and Procedures
    "Controls and Procedures": ["controls", "procedures", "disclosure controls", "internal control"],
...
def extract_metadata_from_query(query: str) -> MetadataFilter:
    ...
    # Detect comparison
    comparison_keywords = {"compare", "difference", "change", "added", "removed", "new", "evolution", "timeline", "vs", "versus"}
