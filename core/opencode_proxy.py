...
Palimind's internals speak the Ollama wire format (see core/generative/responder.py
and core/llm/stream.py, which parse NDJSON lines of shape
...
Run with: ``python3 -m core.opencode_proxy``
"""
...
def _load_api_key() -> str | None:
    ...
    CLI auth.json (via core.opencode_auth, e.g.
...
def _get_embedder():
    ...
    if _embedder is None:
        ...
        model_name = os.environ.get(
            "PALIMIND_LOCAL_EMBED_MODEL", "all-MiniLM-L6-v2"
        )
