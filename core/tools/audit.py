...
from core.settings import TOOL_AUDIT_LOG, TOOL_DEBUG_LOG
...
def read_audit_log(limit: int = 200, offset: int = 0, base_dir: Path | None = None) -> tuple[list[dict[str, Any]], int]:
