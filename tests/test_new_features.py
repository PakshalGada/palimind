...
def test_query_rewriter():
    ...
    res = rewrite_query(query, "https://cuddly-lines-rhyme.loca.lt", "gemma:latest")
...
def test_document_diff():
    ...
    # Run compute_diff
    diff = compute_diff(text2023, text2025, "https://cuddly-lines-rhyme.loca.lt", "nomic-embed-text")
